...
<title>卡说---修改测试用例</title>
</head>
<body>
	<br/>
	<br/>
	<h4 align="center">修改测试用例</h4>
	<br/>
	<br/>

	<form:form action="${pageContext.request.contextPath }/caser/edit" method="POST" modelAttribute="testcase" >
		<!-- path 属性对应html表单标签的name属性 -->
		      <table style="margin-left: auto;margin-right: auto;">
    	      	<tr>
    	      	 <td>用例编号</td>
    	      	 <td><form:input path="caseId" style="height:35px;" size="30" readonly="true"/>
    	      	</tr>
    	      </table>
			<br/>
